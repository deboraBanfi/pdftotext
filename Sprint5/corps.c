...
while(fgets(ligne, 1000, file)){
    ...
    if(strstr(ligne,"CONCLUSIONS") || strstr(ligne, "References") || strstr(ligne, "Conclusions") || strstr(ligne, "CONCLUSION") || strstr(ligne, "Conclusion") || strstr(ligne,"7. Summary") || strstr(ligne,"REFERENCES") || strstr(ligne,"D ISCUSSION") || strstr(ligne,"C ONCLUSIONS") || strstr(ligne,"7. Discussion"))
    {
        j= ftell(file);
